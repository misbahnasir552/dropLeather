...
const CheckboxInput: React.FC<ICheckboxInput> = ({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (onValueChange) {
      if (isStore) {
        if (isChecked) {
          const currentValue = [...currentValues, optionValue];
        ...
        onValueChange(form?.values[name]);
      }
    }
  };
...
// //         ? [...currentValues, optionValue] // Add new selection
// //         : currentValues.filter((value: string) => value !== optionValue); // Remove unchecked value

// //       form?.setFieldValue(name, updatedValues);
// //       setSelectedCheckValue(updatedValues);
// //     } else {
// //       form?.setFieldValue(name, isChecked ? optionValue : ''); // Store only one value
// //       setSelectedCheckValue(isChecked ? optionValue : ''); // Update single selection
// //     }
// //   };
