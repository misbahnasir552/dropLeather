...
const PersonalInfo = () => {
  ...
  const onSubmit = async (values: any, { setSubmitting }: any) => {
    try {
      ...
      // apiClient.post('merchant/sendotp', {
      //   managerMobile: values.managerMobile,
      //   email: values.email,
      // });
                      ...
                      <div className="flex flex-col items-start justify-center gap-4">
                        ...
                        <div className="bg-neutral-white-base p-6">
                          <div className="text-xs leading-tight text-secondary-base">
                            In using this website, you are deemed to have read
                            and agreed to the following terms and conditions.
                            The following terminology applies to these Terms and
                            Conditions, Privacy Statement and applies to these
                            Terms and Conditions Disclaimer Notice and any or
                            all Agree Notice and any other terms and In using
                            this website, you are deemed to have read and agreed
